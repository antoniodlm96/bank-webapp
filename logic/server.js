...
app.get("/apitechu/v2/accounts/:id", accountController.getAccountsV2);
app.post("/apitechu/v2/accounts/", accountController.createAccountV2);
app.delete("/apitechu/v2/account/:iban", accountController.deleteAccountV2);
app.put("/apitechu/v2/modifyAccountBalance/:iban", accountController.modifyAccountBalanceV2);
app.get("/apitechu/v2/checkAccount/:iban", accountController.checkAccountExitsV2);


app.get("/apitechu/v2/getMaxIdUsers/", userController.getMaxIdUsers);
app.post("/apitechu/v2/checkUserMailExists/", userController.checkUserMailExists);

app.get("/apitechu/v2/transactions/:iban",transactionController.getTransactionsV2);
app.post("/apitechu/v2/transactions/",transactionController.createTransactionV2);

app.get("/apitechu/v2/getDivisas/", divisasController.getDivisas);
