...
function checkUserMailExists(req, res) {
  console.log("POST /apitechu/v2/getUserByEmail/");
  ...
  console.log("El email del usuario a buscar es :" + email);

  var query = "q=" + JSON.stringify({"email":email}) + "&c=true";
...
function getMaxIdUsers(req, res){
  ...
  httpClient.get("user?" + mLabAPIKey + "&f={\"id\":1, \"_id\":0}&s={\"id\":-1}&l=1",
    function(err, resMLab, body) {
...
module.exports.getMaxIdUsers = getMaxIdUsers;
module.exports.checkUserMailExists = checkUserMailExists;
